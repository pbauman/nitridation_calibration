...
namespace NitridationCalibration
{
  ...
  PowerGammaNArrheniusGammaCNLikelihood<Vec,Mat>::PowerGammaNArrheniusGammaCNLikelihood( int argc,
                                                                                         char** argv,
                                                                                         MPI_Comm mpi_comm,
  ...
  : GammaNGammaCNLikelihoodBase<Vec,Mat>(argc,argv,mpi_comm,
    ...
    _gamma0_CN_nom( sip_input( "InverseProblem/gamma0_CN_nominal_value", 1.0e-3 ) ),
    ...
    _Tref_N_nom( sip_input( "InverseProblem/Ta_N_nominal_value", 300.0 ) ),
    _alpha_N_nom( sip_input( "InverseProblem/alpha_N_nominal_value", 1.0 ) )
  {
    return;
  }

  template<class Vec,class Mat>
  PowerGammaNArrheniusGammaCNLikelihood<Vec,Mat>::~PowerGammaNArrheniusGammaCNLikelihood()
  {
    return;
  }

  template<class Vec,class Mat>
  void PowerGammaNArrheniusGammaCNLikelihood<Vec,Mat>::update_parameters( const std::vector<double>& params ) const
  {
    if( params.size() != 5 )
      {
        std::cerr << "Error: params size should be 5 for PowerGammaNArrheniusGammaCNLikelihood" << std::endl
    ...
    gamma_N_params[1] = params[3]*_Tref_N_nom;
    gamma_N_params[2] = params[4]*_alpha_N_nom;
  ...
  template class PowerGammaNArrheniusGammaCNLikelihood<uqGslVectorClass,uqGslMatrixClass>;
