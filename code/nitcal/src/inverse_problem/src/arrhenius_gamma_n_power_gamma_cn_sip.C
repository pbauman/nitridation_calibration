...
namespace NitridationCalibration
{
  ...
  ArrheniusGammaNPowerGammaCNSIP<Vec,Mat>::ArrheniusGammaNPowerGammaCNSIP( uqBaseEnvironmentClass* env,
  ...
  template<class Vec,class Mat>
  ArrheniusGammaNPowerGammaCNSIP<Vec,Mat>::~ArrheniusGammaNPowerGammaCNSIP()
  {
    return;
  }

  template<class Vec,class Mat>
  void ArrheniusGammaNPowerGammaCNSIP<Vec,Mat>::create_param_space()
  {
  ...
  template<class Vec,class Mat>
  void ArrheniusGammaNPowerGammaCNSIP<Vec,Mat>::create_param_domain( const GetPot& input )
  {
  ...
  template<class Vec,class Mat>
  void ArrheniusGammaNPowerGammaCNSIP<Vec,Mat>::create_likelihood( int argc,
                                                                   char** argv,
                                                                   MPI_Comm mpi_comm,
  ...
  {
    this->_likelihood = 
      new ArrheniusGammaNPowerGammaCNLikelihood<Vec,Mat>( argc, argv, mpi_comm,
                                                          sip_input,
                                                          forward_run_input,
  ...
  template class ArrheniusGammaNPowerGammaCNSIP<uqGslVectorClass,uqGslMatrixClass>;
