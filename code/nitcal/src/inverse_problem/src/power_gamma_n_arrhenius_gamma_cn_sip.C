...
// NitCal
#include "power_gamma_n_arrhenius_gamma_cn_likelihood.h"
...
namespace NitridationCalibration
{
  ...
  PowerGammaNArrheniusGammaCNSIP<Vec,Mat>::PowerGammaNArrheniusGammaCNSIP( uqBaseEnvironmentClass* env,
  ...
  template<class Vec,class Mat>
  PowerGammaNArrheniusGammaCNSIP<Vec,Mat>::~PowerGammaNArrheniusGammaCNSIP()
  {
    return;
  }

  template<class Vec,class Mat>
  void PowerGammaNArrheniusGammaCNSIP<Vec,Mat>::create_param_space()
  {
    const unsigned int n_params = 5;
  ...
  template<class Vec,class Mat>
  void PowerGammaNArrheniusGammaCNSIP<Vec,Mat>::create_param_domain( const GetPot& input )
  {
    ...
    const double Tref_N_min = input("InverseProblem/Tref_N_min", 0.0);
    const double alpha_N_min = input("InverseProblem/alpha_N_min", 0.0);
  ...
  template<class Vec,class Mat>
  void PowerGammaNArrheniusGammaCNSIP<Vec,Mat>::create_likelihood( int argc,
                                                                   char** argv,
                                                                   MPI_Comm mpi_comm,
  ...
  {
    this->_likelihood = 
      new PowerGammaNArrheniusGammaCNLikelihood<Vec,Mat>( argc, argv, mpi_comm,
                                                          sip_input,
                                                          forward_run_input,
  ...
  template class PowerGammaNArrheniusGammaCNSIP<uqGslVectorClass,uqGslMatrixClass>;
